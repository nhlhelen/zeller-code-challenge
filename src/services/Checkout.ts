...
export class Checkout {
    ...
    scan(item: Item): void {
        ...
        if (existingCartItem) {
            ...
            console.log(`Updated quantity for ${item.name}: ${existingCartItem.quantity}`);
            console.log(`Updated: ${item.name}, qty = ${existingCartItem.quantity}, subtotal = $${existingCartItem.item.price * existingCartItem.quantity}`);
